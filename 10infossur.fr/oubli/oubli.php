...
if ( !isset ( $erreur ) )
{
  ...
  $message = '
  <h1> Voiçi votre nouveau mot de passe :  </h1>
  <p> Mot de passe : <b> '. $password .' </b> </p> </br>
  <p> Pensez à le changer lors de votre prochaine visite ! </p>
  ';
...
<html lang="fr">
  <head>
    <title> 10 infos sur : vous avez oublié votre mot de passe ? </title>
     <!-- méta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Insérez votre adresse e-mail, nous vous renverrons votre mot de passe.">
     <!-- link -->
     <link href="../css/bootstrap.min.css" rel="stylesheet">
     <link href="../css/oubli.min.css" rel="stylesheet">
        ...
        <h1> Mot de passe oublié </h1>
          <div class="col-xl-4 col-xl-offset-4 col-md-6 col-md-offset-3">
            ...
            <form action="oubli.php" method="post" class="p-y-3 p-x-2" novalidate>
              <input type="email" name="email" class="form-control" placeholder="Entrez votre adresse e-mail pour recevoir votre mdp" value="<?php if ( isset ( $email ) ) echo $email; ?>">
